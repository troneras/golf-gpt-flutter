...
@useResult
$Res call({
 String id,@JsonKey(name: 'course_id') String? courseId,@JsonKey(name: 'tee_id') String? teeId, String status,@JsonKey(name: 'start_time') String startTime,@JsonKey(name: 'end_time') String? endTime,@JsonKey(name: 'duration_minutes') int? durationMinutes,@JsonKey(name: 'total_strokes') int? totalStrokes,@JsonKey(name: 'total_putts') int? totalPutts,@JsonKey(name: 'total_penalties') int? totalPenalties,@JsonKey(name: 'score_relative_to_par') int? scoreRelativeToPar,@JsonKey(name: 'distance_walked', fromJson: _parseDoubleOrString) double? distanceWalked,@JsonKey(name: 'fairways_hit') int? fairwaysHit,@JsonKey(name: 'fairways_total') int? fairwaysTotal,@JsonKey(name: 'greens_in_regulation') int? greensInRegulation,@JsonKey(name: 'greens_total') int? greensTotal,@JsonKey(name: 'weather_conditions') String? weatherConditions,@JsonKey(name: 'chatgpt_enabled') bool chatgptEnabled,@JsonKey(name: 'gps_enabled') bool gpsEnabled, String? notes, CourseEntity? course, TeeEntity? tee, List<HoleScoreEntity> scores
});
...
@override@JsonKey(name: 'distance_walked', fromJson: _parseDoubleOrString) final  double? distanceWalked;

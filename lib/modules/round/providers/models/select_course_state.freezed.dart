...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Course course,  Tee? selectedTee,  bool isManuallySelected,  bool gpsEnabled)?  loaded,TResult Function()?  noCourseFound,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SelectCourseStateLoading() when loading != null:
return loading();case SelectCourseStateLoaded() when loaded != null:
return loaded(_that.course,_that.selectedTee,_that.isManuallySelected,_that.gpsEnabled);case SelectCourseStateNoCourseFound() when noCourseFound != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Course course,  Tee? selectedTee,  bool isManuallySelected,  bool gpsEnabled)  loaded,required TResult Function()  noCourseFound,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case SelectCourseStateLoading():
return loading();case SelectCourseStateLoaded():
return loaded(_that.course,_that.selectedTee,_that.isManuallySelected,_that.gpsEnabled);case SelectCourseStateNoCourseFound():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Course course,  Tee? selectedTee,  bool isManuallySelected,  bool gpsEnabled)?  loaded,TResult? Function()?  noCourseFound,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case SelectCourseStateLoading() when loading != null:
return loading();case SelectCourseStateLoaded() when loaded != null:
return loaded(_that.course,_that.selectedTee,_that.isManuallySelected,_that.gpsEnabled);case SelectCourseStateNoCourseFound() when noCourseFound != null:
...
class SelectCourseStateLoaded extends SelectCourseState {
  const SelectCourseStateLoaded({required this.course, this.selectedTee, this.isManuallySelected = false, this.gpsEnabled = true}): super._();
...
@override
int get hashCode => Object.hash(runtimeType,course,selectedTee,isManuallySelected,gpsEnabled);

@override
String toString() {
  return 'SelectCourseState.loaded(course: $course, selectedTee: $selectedTee, isManuallySelected: $isManuallySelected, gpsEnabled: $gpsEnabled)';
}
...
@useResult
$Res call({
 Course course, Tee? selectedTee, bool isManuallySelected, bool gpsEnabled
});
...
/// Create a copy of SelectCourseState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? course = null,Object? selectedTee = freezed,Object? isManuallySelected = null,Object? gpsEnabled = null,}) {

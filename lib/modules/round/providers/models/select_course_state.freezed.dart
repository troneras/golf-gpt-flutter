...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( Course course,  Tee? selectedTee)?  loaded,TResult Function()?  noCourseFound,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case SelectCourseStateLoading() when loading != null:
return loading();case SelectCourseStateLoaded() when loaded != null:
return loaded(_that.course,_that.selectedTee);case SelectCourseStateNoCourseFound() when noCourseFound != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( Course course,  Tee? selectedTee)  loaded,required TResult Function()  noCourseFound,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case SelectCourseStateLoading():
return loading();case SelectCourseStateLoaded():
return loaded(_that.course,_that.selectedTee);case SelectCourseStateNoCourseFound():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( Course course,  Tee? selectedTee)?  loaded,TResult? Function()?  noCourseFound,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case SelectCourseStateLoading() when loading != null:
return loading();case SelectCourseStateLoaded() when loaded != null:
return loaded(_that.course,_that.selectedTee);case SelectCourseStateNoCourseFound() when noCourseFound != null:
...
class SelectCourseStateLoaded extends SelectCourseState {
  const SelectCourseStateLoaded({required this.course, this.selectedTee}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SelectCourseStateLoaded&&(identical(other.course, course) || other.course == course)&&(identical(other.selectedTee, selectedTee) || other.selectedTee == selectedTee));
}


@override
int get hashCode => Object.hash(runtimeType,course,selectedTee);

@override
String toString() {
  return 'SelectCourseState.loaded(course: $course, selectedTee: $selectedTee)';
}
...
/// Create a copy of SelectCourseState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? course = null,Object? selectedTee = freezed,}) {
